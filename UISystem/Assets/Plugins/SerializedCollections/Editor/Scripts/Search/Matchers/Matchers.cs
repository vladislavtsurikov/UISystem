...
namespace AYellowpaper.SerializedCollections.Editor.Search
{
    public static class Matchers
    {
        ...
        public static void AddMatcher(Matcher matcher) => _registeredMatchers.Add(matcher);

        public static bool RemoveMatcher(Matcher matcher) => _registeredMatchers.Remove(matcher);
    }
}
