...
namespace Zenject
{
        ...
        where TValue : Component
    {
        ...
        protected override void OnDestroyed(TValue item) => GameObject.Destroy(item.gameObject);

        protected override void OnSpawned(TValue item) => item.gameObject.SetActive(true);
