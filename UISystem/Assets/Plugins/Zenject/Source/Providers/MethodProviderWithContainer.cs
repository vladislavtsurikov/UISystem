...
namespace Zenject
{
    ...
    public class MethodProviderWithContainer<TValue> : IProvider
    {
        ...
        public MethodProviderWithContainer(Func<DiContainer, TValue> method) => _method = method;

        public bool IsCached => false;

        public bool TypeVariesBasedOnMemberType => false;

        public Type GetInstanceType(InjectContext context) => typeof(TValue);
    ...
    public class MethodProviderWithContainer<TParam1, TValue> : IProvider
    {
        ...
        public MethodProviderWithContainer(Func<DiContainer, TParam1, TValue> method) => _method = method;
    ...
    public class MethodProviderWithContainer<TParam1, TParam2, TValue> : IProvider
    {
        ...
        public MethodProviderWithContainer(Func<DiContainer, TParam1, TParam2, TValue> method) => _method = method;
