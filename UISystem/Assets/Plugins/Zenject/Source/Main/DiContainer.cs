...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
        ...
        public T Instantiate<T>() => Instantiate<T>(new object[0]);
        ...
        public object Instantiate(Type concreteType) => Instantiate(concreteType, new object[0]);
        ...
        public DiContainer CreateSubContainer() => CreateSubContainer(IsValidating);

        public void QueueForInject(object instance) => _lazyInjector.AddInstance(instance);
        ...
        private DiContainer CreateSubContainer(bool isValidating) => new(new[] { this }, isValidating);
        ...
        public List<Type> ResolveTypeAll(Type type) => ResolveTypeAll(type, null);
        ...
        private int GetContainerHeirarchyDistance(DiContainer container) =>
            GetContainerHeirarchyDistance(container, 0).Value;
        ...
        public IEnumerable<Type> GetDependencyContracts<TContract>() => GetDependencyContracts(typeof(TContract));
        ...
        //    Any methods marked with a [Inject] will be called
        //    Any constructor parameters will be filled in with values from the container
        public void Inject(object injectable) => Inject(injectable, new object[0]);
        ...
        public object Resolve(Type contractType) => ResolveId(contractType, null);

        public TContract ResolveId<TContract>(object identifier) => (TContract)ResolveId(typeof(TContract), identifier);
        ...
        public TContract TryResolve<TContract>()
            ...
            (TContract)TryResolve(typeof(TContract));

        public object TryResolve(Type contractType) => TryResolveId(contractType, null);

        public TContract TryResolveId<TContract>(object identifier)
            where TContract : class =>
            (TContract)TryResolveId(
        ...
        public List<TContract> ResolveAll<TContract>() => (List<TContract>)ResolveAll(typeof(TContract));

        public IList ResolveAll(Type contractType) => ResolveIdAll(contractType, null);

        public List<TContract> ResolveIdAll<TContract>(object identifier) =>
            (List<TContract>)ResolveIdAll(typeof(TContract), identifier);
        ...
        public bool Unbind<TContract>() => Unbind(typeof(TContract));

        public bool Unbind(Type contractType) => UnbindId(contractType, null);

        public bool UnbindId<TContract>(object identifier) => UnbindId(typeof(TContract), identifier);
        ...
        public void UnbindInterfacesTo<TConcrete>() => UnbindInterfacesTo(typeof(TConcrete));
        ...
        public bool Unbind<TContract, TConcrete>() => Unbind(typeof(TContract), typeof(TConcrete));

        public bool Unbind(Type contractType, Type concreteType) => UnbindId(contractType, concreteType, null);

        public bool UnbindId<TContract, TConcrete>(object identifier) =>
            UnbindId(typeof(TContract), typeof(TConcrete), identifier);
        ...
        public bool HasBinding<TContract>() => HasBinding(typeof(TContract));

        public bool HasBinding(Type contractType) => HasBindingId(contractType, null);

        public bool HasBindingId<TContract>(object identifier) => HasBindingId(typeof(TContract), identifier);

        public bool HasBindingId(Type contractType, object identifier) =>
            HasBindingId(contractType, identifier, InjectSources.Any);
        ...
        public ConcreteBinderGeneric<TContract> Rebind<TContract>() => RebindId<TContract>(null);
        ...
        public ConcreteBinderNonGeneric Rebind(Type contractType) => RebindId(contractType, null);
        ...
        public ConcreteIdBinderGeneric<TContract> Bind<TContract>() => Bind<TContract>(StartBinding());
        ...
        public ConcreteIdBinderGeneric<TContract> BindNoFlush<TContract>() => Bind<TContract>(StartBinding(false));
        ...
        public FromBinderNonGeneric BindInterfacesTo<T>() => BindInterfacesTo(typeof(T));
        ...
        public FromBinderNonGeneric BindInterfacesAndSelfTo<T>() => BindInterfacesAndSelfTo(typeof(T));
        ...
        public FactoryToChoiceIdBinder<TContract> BindIFactory<TContract>() =>
            BindFactoryInternal<TContract, IFactory<TContract>, PlaceholderFactory<TContract>>();

        public FactoryToChoiceIdBinder<TContract> BindFactory<TContract, TFactory>()
            where TFactory : PlaceholderFactory<TContract> =>
            BindFactoryInternal<TContract, TFactory, TFactory>();
        ...
        public MemoryPoolIdInitialSizeMaxSizeBinder<TItemContract> BindMemoryPoolCustomInterface<TItemContract,
            ...
            BindMemoryPoolCustomInterfaceInternal<TItemContract, TPoolConcrete, TPoolContract>(includeConcreteType,
                StartBinding());
        ...
        public FactoryToChoiceIdBinder<TParam1, TContract> BindFactoryCustomInterface<TParam1, TContract,
            ...
            where TFactoryContract : IFactory =>
            BindFactoryInternal<TParam1, TContract, TFactoryContract, TFactoryConcrete>();
        ...
        public FactoryToChoiceIdBinder<TParam1, TParam2, TContract> BindFactoryCustomInterface<TParam1, TParam2,
            ...
            where TFactoryContract : IFactory =>
            BindFactoryInternal<TParam1, TParam2, TContract, TFactoryContract, TFactoryConcrete>();
        ...
        public FactoryToChoiceIdBinder<TParam1, TParam2, TParam3, TContract> BindFactoryCustomInterface<TParam1,
            ...
            where TFactoryContract : IFactory =>
            BindFactoryInternal<TParam1, TParam2, TParam3, TContract, TFactoryContract, TFactoryConcrete>();
        ...
        public FactoryToChoiceIdBinder<TParam1, TParam2, TParam3, TParam4, TContract> BindFactoryCustomInterface<
            ...
            where TFactoryContract : IFactory =>
            BindFactoryInternal<TParam1, TParam2, TParam3, TParam4, TContract, TFactoryContract, TFactoryConcrete>();
        ...
        public FactoryToChoiceIdBinder<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>
            ...
            TFactoryContract
            where TFactoryContract : IFactory =>
            BindFactoryInternal<TParam1, TParam2, TParam3, TParam4, TParam5, TContract, TFactoryContract,
                TFactoryConcrete>();
        ...
        public
            ...
            where TFactoryContract : IFactory =>
            BindFactoryInternal<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9,
                TParam10, TContract, TFactoryContract, TFactoryConcrete>();

        public T InstantiateExplicit<T>(List<TypeValuePair> extraArgs) => (T)InstantiateExplicit(typeof(T), extraArgs);
        ...
        public void BindExecutionOrder<T>(int order) => BindExecutionOrder(typeof(T), order);
        ...
        public GameObject CreateEmptyGameObject(string name) =>
            CreateEmptyGameObject(new GameObjectCreationParameters { Name = name }, null);
        ...
        public TContract InstantiateComponent<TContract>(GameObject gameObject)
            ...
            InstantiateComponent<TContract>(gameObject, new object[0]);
        ...
        public TContract InstantiateComponent<TContract>(
            ...
            where TContract : Component =>
            (TContract)InstantiateComponent(typeof(TContract), gameObject, extraArgs);
        ...
        public Component InstantiateComponent(
            ...
            InstantiateComponent(componentType, gameObject, new object[0]);
        ...
        public T InstantiateComponentOnNewGameObject<T>()
            where T : Component =>
            InstantiateComponentOnNewGameObject<T>(typeof(T).Name);

        // Note: For IL2CPP platforms make sure to use new object[] instead of new [] when creating
        // the argument list to avoid errors converting to IEnumerable<object>
        public T InstantiateComponentOnNewGameObject<T>(IEnumerable<object> extraArgs)
            where T : Component =>
            InstantiateComponentOnNewGameObject<T>(typeof(T).Name, extraArgs);

        public T InstantiateComponentOnNewGameObject<T>(string gameObjectName)
            where T : Component =>
            InstantiateComponentOnNewGameObject<T>(gameObjectName, new object[0]);
        ...
        public GameObject InstantiatePrefab(
            ...
            InstantiatePrefab(
                ...
                {
                    ParentTransform = parentTransform, Position = position, Rotation = rotation
                });
        ...
        public GameObject InstantiatePrefabResource(string resourcePath) =>
            InstantiatePrefabResource(resourcePath, GameObjectCreationParameters.Default);

        // Create a new game object from a resource path and fill in dependencies for all children
        public GameObject InstantiatePrefabResource(string resourcePath, Transform parentTransform) =>
            InstantiatePrefabResource(resourcePath,
        ...
        public T InstantiatePrefabForComponent<T>(Object prefab) =>
            (T)InstantiatePrefabForComponent(
        ...
        public T InstantiatePrefabResourceForComponent<T>(
            string resourcePath, Vector3 position, Quaternion rotation, Transform parentTransform) =>
            InstantiatePrefabResourceForComponent<T>(resourcePath, position, rotation, parentTransform, new object[0]);
        ...
        public T InstantiateScriptableObjectResource<T>(string resourcePath)
            ...
            InstantiateScriptableObjectResource<T>(resourcePath, new object[0]);
        ...
        public T InstantiateScriptableObjectResource<T>(
            string resourcePath, IEnumerable<object> extraArgs)
            where T : ScriptableObject =>
            (T)InstantiateScriptableObjectResource(
        ...
        public T InjectGameObjectForComponent<T>(GameObject gameObject)
            where T : Component =>
            InjectGameObjectForComponent<T>(gameObject, new object[0]);
        ...
        public T InjectGameObjectForComponent<T>(
            GameObject gameObject, IEnumerable<object> extraArgs)
            where T : Component =>
            (T)InjectGameObjectForComponent(gameObject, typeof(T), extraArgs);
