...
namespace Zenject
{
    ...
    public static class TypeAnalyzer
    {
        ...
        public static bool ShouldAllowDuringValidation<T>() => ShouldAllowDuringValidation(typeof(T));
        ...
        public static bool HasInfo<T>() => HasInfo(typeof(T));

        public static bool HasInfo(Type type) => TryGetInfo(type) != null;

        public static InjectTypeInfo GetInfo<T>() => GetInfo(typeof(T));
        ...
        public static InjectTypeInfo TryGetInfo<T>() => TryGetInfo(typeof(T));
        ...
        public static bool ShouldSkipTypeAnalysis(Type type) =>
            type == null || type.IsEnum() || type.IsArray || type.IsInterface()
