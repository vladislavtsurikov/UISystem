...
namespace Zenject.ReflectionBaking
{
    public static class CecilExtensions
    {
        ...
        public static TypeReference ImportType<T>(this ModuleDefinition module) => module.ImportType(typeof(T));

        public static TypeReference ImportType(this ModuleDefinition module, Type type) => module.Import(type);

        public static MethodReference ImportMethod<T>(this ModuleDefinition module, string methodName) =>
            module.ImportMethod(typeof(T), methodName);
        ...
        public static MethodReference ImportMethod<T>(
            ...
            module.ImportMethod(typeof(T), methodName, numArgs);
