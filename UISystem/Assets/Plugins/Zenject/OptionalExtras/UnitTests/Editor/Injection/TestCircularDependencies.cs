...
namespace Zenject.Tests.Injection
{
    ...
    public class TestCircularDependencies : ZenjectUnitTestFixture
    {
        ...
        private class Test3
        {
            ...
            public Test3() => CreateCount++;

            [Inject]
            public void Initialize(Test4 other) => Other = other;
        }
        ...
        private class Test4
        {
            ...
            public Test4() => CreateCount++;

            [Inject]
            public void Initialize(Test3 other) => Other = other;
        }
        ...
        private class Test5
        {
            public Test5(Test6 Other) => Assert.IsNotNull(Other);
        }
