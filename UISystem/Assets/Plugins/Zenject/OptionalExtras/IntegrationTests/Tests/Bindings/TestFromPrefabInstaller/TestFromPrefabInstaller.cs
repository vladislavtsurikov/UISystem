...
namespace Zenject.Tests.Bindings.FromPrefabInstaller
{
    public class TestFromPrefabInstaller : ZenjectIntegrationTestFixture
    {
        ...
        private void InstallFoo(DiContainer subContainer) => subContainer.Bind<Qux>().AsSingle().WithArguments("asdf");
        ...
        {
            public override void InstallBindings() => Container.Bind<Qux>().AsSingle().WithArguments("asdf");
        }
    }
}
