...
namespace Zenject
{
    public class SignalBus : ILateDisposable
    {
        ...
        public void AbstractFireId<TSignal>(object identifier, TSignal signal)
        {
            ...
            for (var i = 0; i < numOfInterfaces; i++)
            {
        ...
        public void Fire<TSignal>(TSignal signal) => FireId(null, signal);

        public void FireId<TSignal>(object identifier) => InternalFire(typeof(TSignal), null, identifier, true);

        public void Fire<TSignal>() => FireId<TSignal>(null);

        public void FireId(object identifier, object signal) =>
            InternalFire(signal.GetType(), signal, identifier, true);

        public void Fire(object signal) => FireId(null, signal);

        public bool IsSignalDeclared<TSignal>() => IsSignalDeclared(typeof(TSignal), null);

        public bool IsSignalDeclared<TSignal>(object identifier) => IsSignalDeclared(typeof(TSignal), identifier);

        public bool IsSignalDeclared(Type signalType) => IsSignalDeclared(signalType, null);
        ...
        public void TryFire<TSignal>(TSignal signal) => TryFireId(null, signal);

        public void TryFireId<TSignal>(object identifier) => InternalFire(typeof(TSignal), null, identifier, false);

        public void TryFire<TSignal>() => TryFireId<TSignal>(null);

        public void TryFireId(object identifier, object signal) =>
            InternalFire(signal.GetType(), signal, identifier, false);

        public void TryFire(object signal) => TryFireId(null, signal);
        ...
        public void Subscribe<TSignal>(Action callback) => SubscribeId<TSignal>(null, callback);
        ...
        public void Subscribe<TSignal>(Action<TSignal> callback) => SubscribeId(null, callback);
        ...
        public void Subscribe(Type signalType, Action<object> callback) => SubscribeId(signalType, null, callback);

        public void UnsubscribeId<TSignal>(object identifier, Action callback) =>
            UnsubscribeId(typeof(TSignal), identifier, callback);

        public void Unsubscribe<TSignal>(Action callback) => UnsubscribeId<TSignal>(null, callback);
        ...
        public void Unsubscribe(Type signalType, Action callback) => UnsubscribeId(signalType, null, callback);

        public void UnsubscribeId(Type signalType, object identifier, Action<object> callback) =>
            UnsubscribeInternal(signalType, identifier, callback, true);

        public void Unsubscribe(Type signalType, Action<object> callback) => UnsubscribeId(signalType, null, callback);
        ...
        public void Unsubscribe<TSignal>(Action<TSignal> callback) => UnsubscribeId(null, callback);
        ...
        public void TryUnsubscribe<TSignal>(Action callback) => TryUnsubscribeId<TSignal>(null, callback);
        ...
        public void TryUnsubscribe(Type signalType, Action callback) => TryUnsubscribeId(signalType, null, callback);
        ...
        public void TryUnsubscribe<TSignal>(Action<TSignal> callback) => TryUnsubscribeId(null, callback);
        ...
        private SignalDeclaration GetDeclaration(BindingId signalId)
        {
            ...
            if (ParentBus != null)
            {
                return ParentBus.GetDeclaration(signalId);
            }
